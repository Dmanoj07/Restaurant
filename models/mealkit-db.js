...
const getTopMealkits = function () {
  // tODO: fetch data from server
  return mealData;
};
const getMealkitsByCategory = function () {
  var filtered = [{
    category: "",
    meal: []
  }, {
...
const mealModel = mongoose.model("meal-kits", mealSchema)
module.exports = { mealModel, getTopMealkits, getMealkitsByCategory };
